...
OBJECTFILES= \
	...
	${OBJECTDIR}/Command/SC_RemoveSubscriber.o \
...
LDLIBSOPTIONS=-lpthread -lSDLmain -lSDL -lpqxx
...
${OBJECTDIR}/Command/SC_ObjProces.o: Command/SC_ObjProces.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Command/SC_ObjProces.o Command/SC_ObjProces.cpp

${OBJECTDIR}/Powers/SEffectTypeAddBuff.o: Powers/SEffectTypeAddBuff.cpp 
	${MKDIR} -p ${OBJECTDIR}/Powers
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Powers/SEffectTypeAddBuff.o Powers/SEffectTypeAddBuff.cpp
...
${OBJECTDIR}/Powers/SEffectType.o: Powers/SEffectType.cpp 
	${MKDIR} -p ${OBJECTDIR}/Powers
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Powers/SEffectType.o Powers/SEffectType.cpp

${OBJECTDIR}/objects/Buffs/SBuffDot.o: objects/Buffs/SBuffDot.cpp 
	${MKDIR} -p ${OBJECTDIR}/objects/Buffs
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/objects/Buffs/SBuffDot.o objects/Buffs/SBuffDot.cpp
...
${OBJECTDIR}/objects/Buffs/SBuff.o: objects/Buffs/SBuff.cpp 
	${MKDIR} -p ${OBJECTDIR}/objects/Buffs
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/objects/Buffs/SBuff.o objects/Buffs/SBuff.cpp

${OBJECTDIR}/Powers/SPowerTypeLoader.o: Powers/SPowerTypeLoader.cpp 
	${MKDIR} -p ${OBJECTDIR}/Powers
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Powers/SPowerTypeLoader.o Powers/SPowerTypeLoader.cpp
...
${OBJECTDIR}/objects/Buffs/SBuffStat.o: objects/Buffs/SBuffStat.cpp 
	${MKDIR} -p ${OBJECTDIR}/objects/Buffs
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/objects/Buffs/SBuffStat.o objects/Buffs/SBuffStat.cpp

${OBJECTDIR}/Command/SC_KillUnit.o: Command/SC_KillUnit.cpp 
	${MKDIR} -p ${OBJECTDIR}/Command
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Command/SC_KillUnit.o Command/SC_KillUnit.cpp
...
${OBJECTDIR}/Command/SC_RemoveSubscriber.o: Command/SC_RemoveSubscriber.cpp 
	${MKDIR} -p ${OBJECTDIR}/Command
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Command/SC_RemoveSubscriber.o Command/SC_RemoveSubscriber.cpp
...
${OBJECTDIR}/Powers/SEffectTypeDD.o: Powers/SEffectTypeDD.cpp 
	${MKDIR} -p ${OBJECTDIR}/Powers
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Powers/SEffectTypeDD.o Powers/SEffectTypeDD.cpp
